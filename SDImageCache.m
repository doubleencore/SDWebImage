...
- (UIImage *)imageFromKey:(NSString *)key fromDisk:(BOOL)fromDisk
{
    ...
    if (!image && fromDisk)
    {
        UIImage *savedImage = [[UIImage alloc] initWithData:[NSData dataWithContentsOfFile:[self cachePathForKey:key]]];
        image = [UIImage imageWithCGImage:savedImage.CGImage scale:[UIScreen mainScreen].scale orientation:UIImageOrientationUp];
        [savedImage release];
